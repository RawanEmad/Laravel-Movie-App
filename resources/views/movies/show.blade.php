...
@section('content')
        ...
        <div class="container mx-auto px-4 py-16 flex flex-col md:flex-row">
            ...
            <div class="md:ml-24">
                ...
                <div class="mt-12">
                    <button 
                    @click="isOpen = true"
                    class="flex inline-flex items-center bg-red-500 bg-yellow-500 text-gray-900 rounded font-semibold px-5
    ...
    <div class="movie-cast border-b border-gray-800">
        ...
        <div class="movie-images border-b border-gray-800" x-data="{isOpen : false, image : ''}">
            ...
            </div> <!--End of movie-images section-->
    </div>
@endsection